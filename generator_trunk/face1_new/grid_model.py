...
TEMPLATES: tuple[CellTemplate, ...] = (
    ...
    CellTemplate("permut_empty", "Permute · ()", "Order", "FW_Permut()", "All n! orderings of the values (same as bare FW_Permut).", "#3159c6"),
    CellTemplate("permut_k", "Permute · k", "Order", "FW_Permut(2)", "Accepted, but k is ignored: all n! orderings. For k-permutations put FW_Combi(k) here and FW_Permut() in the next cell.", "#3159c6"),
