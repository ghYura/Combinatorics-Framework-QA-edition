...
public class QueryToDB3 {

private String host = "localhost";
private int port = 5433;
private String database = "DB2";
private String user = "postgres";
private String url = "jdbc:pgsql:"+host+":"+port+"/"+database+"";

Driver driver;
PGDataSource pgDataSource;
PGConnectionPoolDataSource pgConnectionPoolDataSource;
PooledConnection pgPooledConn;
...
public void init(boolean isDataSourceMode){


pgDataSource = new PGDataSource();

String url = "jdbc:pgsql:"+cfg().dbHost()+":"+cfg().dbPort()+"/"+cfg().dbName();
String user = cfg().dbUser();
String password = cfg().dbPassword();
